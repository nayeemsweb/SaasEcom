...
:: Define Main Project Path Here
set mainProject=../src/Ecommerce/Ecommerce.Web

:: Define Other DbContext Here
set dbcontext[0]=ApplicationDbContext
set dbcontext[1]=StoreDbContext
:: Don't modify in the below

title SaasEcom Migration Runner
...
cls
echo:
echo ============ SaasEcom Migration Runner ==============
echo: 
...
echo:
endlocal
set /p choice="Press enter go to removed migration menu..."
...
echo:
endlocal
set /p choice="Press enter go to create migration menu..."
...
echo:
endlocal
set /p choice="Press enter go to apply migration menu..."
