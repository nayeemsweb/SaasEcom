...
{
    public class ProductSubscriptionEditModel
    {
        ...
        public ProductSubscriptionEditModel()
        {

        }

        public ProductSubscriptionEditModel(IMapper mapper, IProductSubscriptionService productSubscriptionService, IProductService productService)
        {
        ...
        public void EditProductSubscriptionNotification()
        {
            var productSubscriptionNotification = _mapper.Map<ProductSubscriptionNotification>(this);

            _productSubscriptionService.EditProductSubscriptionNotification(productSubscriptionNotification);
        }
